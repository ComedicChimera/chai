...
class SymbolTable:
    ...
    # resolution failed.
    resolution_failed: MutableSet[str]
    ...
    def define(self, sym: Symbol, rel_path: str) -> Optional[Symbol]:
    ...
    def lookup(self, pkg_id: int, rel_path: str, pos: TextPosition, name: str, 
        def_kind: DefKind = DefKind.ValueDef, mutability: Mutability = Mutability.NeverMutated):
    ...
    def _resolve(self, sym: Symbol) -> Optional[Symbol]:
    ...
    def _error_unresolved(self, name: str, msg: str, filter_cond: Optional[Callable[[SymbolReference], bool]] = None):
        if filter_cond:
